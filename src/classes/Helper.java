...
public class Helper {
    ...
    public static void F1(JTable tabla1, JTable tabla2) {
        int nf, nc, aux;
        nc = tabla1.getColumnCount();
        nf = tabla1.getRowCount();
    ...
    public static void F2(JTable tabla1, JTable tabla2) {
        int nf, nc, aux;
        nc = tabla1.getColumnCount();
        nf = tabla1.getRowCount();
    ...
    public static void F3(JTable tabla1, JTable tabla2) {
        int nf, nc, aux;
        nc = tabla1.getColumnCount();
        nf = tabla1.getRowCount();
    ...
    public static void F4(JTable tabla1, JTable tabla2) {
        int nf, nc, aux;
        nc = tabla1.getColumnCount();
        nf = tabla1.getRowCount();
        ...
        for (int i = 0; i < nf; i++) {
            for (int j = 0; j < nc; j++) {
                aux = (int) tabla1.getValueAt(i, j);
                if ((i == j+nf/2 ||nf - i + nf/2-1 == j  )||( nf/2 - i == j  || i == j-nf/2)) {
                    tabla2.setValueAt(aux, i, j);
                }
    ...
    public static void letraQ(JTable tabla1, JTable tabla2) {
        ...
        for (int i = 0; i < nf; i++) {
            for (int j = 0; j < nc; j++) {
                aux = (int) tabla1.getValueAt(i, j);
                if (i == 0 && j != 0 && j != nf - 1 || (((nf / 2 + 1) == i && j != 0 && j != nf - 1))|| (j == 0 && i <= nf / 2 && i != 0) || 
                        (((nf / 2 + 1) == i && j != 0 && j != nf - 1)) || (j == nc - 1 && i <= nf / 2 && i != 0) || (i == j && i > nf / 2)) {
                    tabla2.setValueAt(aux, i, j);
                }
            }
    ...
    public static void letraG(JTable tabla1, JTable tabla2) {
        ...
        for (int i = 0; i < nf; i++) {
            for (int j = 0; j < nc; j++) {
                aux = (int) tabla1.getValueAt(i, j);
                if (i==0||j==0||i==nf-1||(i == nf / 2) ||(j == nc - 1 && j / i <= 1 )||  (j == nc - 1 && j / i >= nc - 1)) {
                    tabla2.setValueAt(aux, i, j);
                }
            }
    ...
    public static void letraR(JTable tabla1, JTable tabla2) {
        ...
        for (int i = 0; i < nf; i++) {
            for (int j = 0; j < nc; j++) {
                aux = (int) tabla1.getValueAt(i, j);
                if (i == 0 || j == 0||( j == nc-1 && j/i>=2)||i==nf/2||i==j && i+j>=nf) {
                    tabla2.setValueAt(aux, i, j);
                }
            }
    ...
    public static void letraB(JTable tabla1, JTable tabla2) {
        ...
        for (int i = 0; i < nf; i++) {
            for (int j = 0; j < nc; j++) {
                aux = (int) tabla1.getValueAt(i, j);
                if ((i==0 && j!=nc-1)||j==0||(i==nf/2 && j!=nc-1)||(i==nf-1 && j!=nc-1)
